...
torch.T7Reader = class {
    ...
    constructor(buffer, callback) {
        ...
        this._registry = {};
        this._registry['bnn.Binary'] = function (reader) {
            reader.nn(this);
        };
        this._registry['bnn.SpatialConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.BatchNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.ReLU'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.Sigmoid'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.LogSoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialAveragePooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialBatchNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialFullConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialMaxPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.SpatialSoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.Tanh'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.VolumetricAveragePooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.VolumetricBatchNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.VolumetricConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['cudnn.VolumetricMaxPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['Dict'] = function (reader) {
            reader.nn(this);
        };
        this._registry['inn.ConstAffine'] = function (reader) {
            reader.nn(this);
        };
        this._registry['inn.SpatialMaxPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Abs'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.AddConstant'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.BatchNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.BilinearSamplerBHWD'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.BinActiveZ'] = function (reader) {
            reader.nn(this);
        }; // allenai/XNOR-Net
        this._registry['nn.BCECriterion'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CMul'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CAddTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CDivTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CMulTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CSubTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Concat'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Copy'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ConcatTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Contiguous'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Constant'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.CostVolMulti'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.DepthConcat'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Dropout'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Exp'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ExpOut'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.FlattenTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.GenNoise'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Identity'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Index'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Inception'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.InstanceNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.JoinTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.JointTrain'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.KeypointCoordinate'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.LeakyReLU'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Linear'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.LinearNoBias'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.LogSoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.LookupTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.LSTM'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.MaskZero'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.MapTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Max'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Mean'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Min'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.MulConstant'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.MM'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.MSECriterion'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Narrow'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.NarrowTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Normalize'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Normalize2'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.NoiseFill'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Padding'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Parallel'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ParallelCriterion'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ParallelTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.PixelShuffle'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Power'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.PReLU'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Recursor'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ReLU'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Replicate'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Reshape'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.ShaveImage'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Select'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SelectTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Sequencer'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Sequential'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Sigmoid'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Sum'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialAveragePooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialBatchNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialConvolutionMM'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialCrossMapLRN'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialDilatedConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialDropout'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialFractionalMaxPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialFullConvolution'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialLPPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialMaxPooling'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialReflectionPadding'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialReplicationPadding'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialSoftMax'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialSubtractiveNormalization'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialUpSamplingBilinear'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialUpSamplingNearest'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SpatialZeroPadding'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.SplitTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Squeeze'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Square'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Sqrt'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.StereoJoin'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Tanh'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Transpose'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.TotalVariation'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.Unpool'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.View'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nn.gModule'] = function (reader) {
            reader.nn(this);
        };
        this._registry['nngraph.Node'] = function (reader) {
            reader.nn(this);
        };
        this._registry['graph.Edge'] = function (reader) {
            reader.nn(this);
        };
        this._registry['graph.Graph'] = function (reader) {
            reader.nn(this);
        };
        this._registry['torch.ByteTensor'] = function (reader) {
            reader.tensor(this, 'uint8');
        };
        this._registry['torch.CharTensor'] = function (reader) {
            reader.tensor(this, 'int8');
        };
        this._registry['torch.ShortTensor'] = function (reader) {
            reader.tensor(this, 'int16');
        };
        this._registry['torch.IntTensor'] = function (reader) {
            reader.tensor(this, 'int32');
        };
        this._registry['torch.LongTensor'] = function (reader) {
            reader.tensor(this, 'int64');
        };
        this._registry['torch.FloatTensor'] = function (reader) {
            reader.tensor(this, 'float32');
        };
        this._registry['torch.DoubleTensor'] = function (reader) {
            reader.tensor(this, 'float64');
        };
        this._registry['torch.CudaByteTensor'] = function (reader) {
            reader.tensor(this, 'uint8');
        };
        this._registry['torch.CudaCharTensor'] = function (reader) {
            reader.tensor(this, 'int8');
        };
        this._registry['torch.CudaShortTensor'] = function (reader) {
            reader.tensor(this, 'int16');
        };
        this._registry['torch.CudaIntTensor'] = function (reader) {
            reader.tensor(this, 'int32');
        };
        this._registry['torch.CudaLongTensor'] = function (reader) {
            reader.tensor(this, 'int64');
        };
        this._registry['torch.CudaTensor'] = function (reader) {
            reader.tensor(this, 'float32');
        };
        this._registry['torch.CudaDoubleTensor'] = function (reader) {
            reader.tensor(this, 'float64');
        };
        this._registry['torch.ByteStorage'] = function (reader) {
            reader.storage(this, 'uint8', 1);
        };
        this._registry['torch.CharStorage'] = function (reader) {
            reader.storage(this, 'int8', 1);
        };
        this._registry['torch.ShortStorage'] = function (reader) {
            reader.storage(this, 'int16', 2);
        };
        this._registry['torch.IntStorage'] = function (reader) {
            reader.storage(this, 'int32', 4);
        };
        this._registry['torch.LongStorage'] = function (reader) {
            reader.storage(this, 'int64', 8);
        };
        this._registry['torch.FloatStorage'] = function (reader) {
            reader.storage(this, 'float32', 4);
        };
        this._registry['torch.DoubleStorage'] = function (reader) {
            reader.storage(this, 'float64', 8);
        };
        this._registry['torch.CudaByteStorage'] = function (reader) {
            reader.storage(this, 'uint8', 1);
        };
        this._registry['torch.CudaCharStorage'] = function (reader) {
            reader.storage(this, 'int8', 1);
        };
        this._registry['torch.CudaShortStorage'] = function (reader) {
            reader.storage(this, 'int16', 2);
        };
        this._registry['torch.CudaIntStorage'] = function (reader) {
            reader.storage(this, 'int32', 4);
        };
        this._registry['torch.CudaLongStorage'] = function (reader) {
            reader.storage(this, 'int64', 8);
        };
        this._registry['torch.CudaIntStorage'] = function (reader) {
            reader.storage(this, 'int32', 4);
        };
        this._registry['torch.CudaStorage'] = function (reader) {
            reader.storage(this, 'float32', 4);
        };
        this._registry['torch.CudaFloatStorage'] = function (reader) {
            reader.storage(this, 'float64', 8);
        };
        this._registry['w2nn.AuxiliaryLossTable'] = function (reader) {
            reader.nn(this);
        };
        this._registry['w2nn.InplaceClip01'] = function (reader) {
            reader.nn(this);
        };
        this._registry['w2nn.ScaleTable'] = function (reader) {
            reader.nn(this);
        };
